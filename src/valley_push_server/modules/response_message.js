module.exports = {
    ...
    NOT_VALID_EMAIL: '이메일이 아닙니다.',
    NO_RANDOM_NUM: '인증 코드 생성 실패',
    ...
    // 알림 전송 성공
    SEND_NOTIFICATION: '알림 기록 전송',
    NO_RECEIVE_USER: '알림 받을 유저가 없음(비로그인 또는 회원이 아님)',
    NO_REVEIVED_MESSAGE: '알림 메세지가 없습니다.',
